...
def get_arguments():
	...
	parse.add_arguments("--learning_rate", dest="learning_rate", default  = 0.1, 
						help="Boosting learning rate")						
	parse.add_arguments("--n_estimators", dest="n_estimators", default  = 100,
	...
	parse.add_arguments("--num_leaves", dest="num_leaves", default  = 31,
						help="max number of leaves in one tree")						
	parse.add_arguments("--max_depth", dest="max_depth", default  = -1, 
	...
	parse.add_arguments("--verbose", dest="verbose", default = 1, help=' -1 = silent, 0 = warn, 1 = info')						
